...
.title-small {
	...
	<section class="bg-black" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center" style="padding:120px 0px 100px 0px">
<!--                     <div class="section-heading about-year text-uppercase white-text"><span class="clearfix">20</span>Years</div>
 -->                    <div class="section-heading about-year text-uppercase white-text"> Years<span class="clearfix">20</span></div>
